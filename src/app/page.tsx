                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div className="flex gap-1">
                            {[...Array(5)].map((_, i) => (
                                <div
                                    key={i}
                                    className={`w-3 h-3 rounded-full ${i < 5 ? "bg-[#f28b1b]" : "bg-gray-300"
                                        } animate-pulse`}
                        ...
                        <div className="space-y-6 font-comfortaa">
                            {[
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p
                                            className={`text-lg ${item.strong ? "font-bold text-[#5c4394]" : ""
                                                }`}
                                        >
                                            {item.text}
                                        </p>
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex gap-2 mt-4">
                                {[...Array(4)].map((_, i) => (
                                    <div
                                        key={i}
                                        className={`w-4 h-4 rounded-full transition-all duration-300 ${i < 2 ? "bg-[#f28b1b] animate-pulse" : "bg-gray-300"
                                            }`}
                                        style={{ animationDelay: `${i * 0.2}s` }}
                                    />
                                ))}
            ...
            <div className="bg-gradient-to-r from-white to-gray-50 shadow-2xl relative">
                <div className="flex relative">
                    ...
                    {steps.map((step, index) => (
                        <div
                            key={index}
                            className={`flex-1 py-4 px-4 text-center font-comfortaa font-bold text-white relative z-10 transition-all duration-500 transform ${index <= currentStep
                                ? "bg-gradient-to-r from-[#f28b1b] to-[#ff6b1a] scale-105"
                                : "bg-gradient-to-r from-[#5c4394] to-[#7c64b4] hover:scale-105"
                                } ${index === 0 ? "rounded-tl-none" : ""} ${index === steps.length - 1 ? "rounded-tr-none" : ""
                                }`}
                        >
                            ...
                            <div
                                className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${index <= currentStep
